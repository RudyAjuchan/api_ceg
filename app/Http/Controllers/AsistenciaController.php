...
class AsistenciaController extends Controller
{
    ...
    public function estadisticaAsistencia(Request $request){
        ...
        $todo = [];
        $data1 = new stdClass();
        $data1->nombre = "asistencias";
        $data1->porcentaje = $asistenciasT;
        $data1->color = 'Colors.green';
        array_push($todo, $data1);
        $data2 = new stdClass();
        $data2->nombre = "inasistencias";
        $data2->porcentaje = $inasistenciasT;
        $data2->color = 'Colors.red';
        array_push($todo, $data2);
        $data3 = new stdClass();
        $data3->nombre = "justificaciones";
        $data3->porcentaje = $justificacionesT;
        $data3->color = 'Colors.blue';
        array_push($todo, $data3);
    ...
    public function getToken(Request $request){
        ...
        $tokens = DB::table('detalle_token_notification as dtk')->join('token_notification as tn', 'tn.id', '=', 'dtk.id_token')
        ->where('dtk.id_alumno', $request->carnet)->get();
